 ...
 * Date: 4/10/2018
 * Time: 7:21 PM
 * Description: This file was created to display navigation menu and footer across all pages.
 */
class IndexView {
    public static function displayHeader($title) {
        // retrieve user and role session variables
        ...
        <html>
            <head>
                ...
                <!-- add bootstrap framework styling -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php
                                        // if user is present and user is also admin show create links for books and movies and show logout
                                        // otherwise display login signup links.
                                            if($user){
                                                if($role) {
                                                    ?>
    ...
    public static function displayFooter () {
        ?>
                ...
                <!-- add jquery, bootstrap dependencies as well as autosugestion ajax code. -->
